...
function Agence() {
  ...
  useGSAP(function () {
    gsap.to(imageRefDiv.current, {
      scrollTrigger: {
        trigger: imageRefDiv.current,
        start: "top 27%",
        end: "top -120%",
        pin: true,
  ...
  return (
    <div>
      <div className="section1">
        <div
          ref={imageRefDiv}
          className="w-[15vw] h-[20vw] rounded-3xl overflow-hidden absolute top-[14vw] left-[30vw]"
        >
          <img
            ref={imageRef}
